...
const AutoRenewalApplicationRenewal: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Table - Using structure from 1st code */}
                ...
                {currentApplications.map((app, index) => (
                  <tr key={app.id} className="border-b bg-white hover:bg-gray-50 align-top">
                    ...
                    <td className="px-4 py-4 text-sm text-gray-800">
                      ...
                      <p className="text-[15px] absolute p-[3px] bg-amber-50">Auto Renewal</p>
                    </td>
                    ...
                    <td className="px-4 py-4 text-sm space-y-1 text-blue-700">
                      ...
                      <Link
                        to={`/notesheet/${app.applicationNo}`}
                        className="hover:underline block"
                      >
                        Notesheet
                      </Link>
                      <Link
                        to={`/licence-register/${app.applicationNo}`}
                        className="hover:underline block"
                      >
                        Licence Register
                      </Link>
                      ...
                      <Link
                        to={`/payment-details/${app.applicationNo}`}
                        className="hover:underline block"
                      >
                        Payment Details
                      </Link>
                      <Link
                        to={`/download-certificates/${app.applicationNo}`}
                        className="hover:underline block"
                      >
        ...
        {/* Pagination - Using enhanced pagination from 2nd code */}
...
export default AutoRenewalApplicationRenewal;