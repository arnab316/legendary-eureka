...
const BackForRectificationRenewal: React.FC = () => {
  ...
  // Filter applications (only by search)
              ...
              <tbody>
                {currentApplications.map((app, index) => (
                  <tr key={app.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-4 py-4 text-sm">
                      <p className="font-bold text-blue-700 text-base">{app.status}</p>
...
export default BackForRectificationRenewal;
