...
const UnderProcessApplicationRenewal: React.FC = () => {
                  ...
                  currentApplications.map((app, index) => (
                    <tr key={app.id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="px-4 py-4 text-sm space-y-1">
                        <div>
                          <Link to={`/application/view/${app.applicationNo}`} className="text-blue-600 hover:text-blue-800 hover:underline"><FaRegEye />View</Link>
...
export default UnderProcessApplicationRenewal;
